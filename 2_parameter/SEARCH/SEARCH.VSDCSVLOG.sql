SET DEFINE OFF;DELETE FROM SEARCH WHERE 1 = 1 AND NVL(SEARCHCODE,'NULL') = NVL('VSDCSVLOG','NULL');Insert into SEARCH   (SEARCHCODE, SEARCHTITLE, EN_SEARCHTITLE, SEARCHCMDSQL, OBJNAME, FRMNAME, ORDERBYCMDSQL, TLTXCD, CNTRECORD, ROWPERPAGE, AUTOSEARCH, INTERVAL, AUTHCODE, ROWLIMIT, CMDTYPE, CONDDEFFLD, BANKINQ, BANKACCT, CHKSCOPECMDSQL) Values   ('VSDCSVLOG', 'Tra cứu file csv nhận từ VSD', 'Look up csv file received from VSD', 'SELECT DT2.*, A1.CDCONTENT CTRADEPLACE
FROM
(
...
LEFT JOIN ALLCODE A1 ON A1.CDTYPE = ''ST'' AND A1.CDNAME = ''TRADEPLACE'' AND A1.CDVAl = DT2.TRADEPLACE', 'CFMAST', 'frmMT598', 'TIMECREATED DESC', '', 0, 5000, 'Y', 30, '', 'Y', 'T', '', 'N', '', '');COMMIT;