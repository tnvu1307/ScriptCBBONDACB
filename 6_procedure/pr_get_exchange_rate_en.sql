SET DEFINE OFF;
CREATE OR REPLACE PROCEDURE pr_get_exchange_rate_en (PV_REFCURSOR IN OUT PKG_REPORT.REF_CURSOR,
...
begin
    ...
    if TellerId='0001' THEN --Admin he thong
        ...
        FROM ( SELECT currency, vnd, to_char(lastchange,''DD/MM/RRRR hh24:mm:ss'') lastchange FROM exchangerate)  WHERE 0=0 ';
