SET DEFINE OFF;
CREATE OR REPLACE PACKAGE txpks_#1703ex
/**----------------------------------------------------------------------------------------------------
 ** Package: TXPKS_#1703EX
...
CREATE OR REPLACE PACKAGE BODY txpks_#1703ex
IS
   pkgctx   plog.log_ctx;
...
BEGIN
    ...
    ***************************************************************************************************/
    IF P_TXMSG.DELTD <> 'Y' THEN
        ...
        SELECT COUNT(1) INTO L_COUNT FROM CFMAST_TPRL WHERE CUSTODYCD = L_CUSTODYCD;
