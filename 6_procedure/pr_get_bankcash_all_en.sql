SET DEFINE OFF;
CREATE OR REPLACE PROCEDURE pr_get_bankcash_all_en (PV_REFCURSOR IN OUT PKG_REPORT.REF_CURSOR,
...
begin
    ...
    if TellerId='0001' THEN --Admin he thong
        v_sql:='SELECT REFCASAACCT,CCYCD,BANKBALANCE,BANKHOLDBALANCE
        FROM ( select CUSTODYCD,REFCASAACCT,CCYCD,BANKBALANCE,BANKHOLDBALANCE from  vw_ddmast_all)  WHERE 0=0 ';
