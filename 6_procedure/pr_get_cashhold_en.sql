SET DEFINE OFF;
CREATE OR REPLACE PROCEDURE pr_get_cashhold_en (PV_REFCURSOR IN OUT PKG_REPORT.REF_CURSOR,
...
begin
    ...
    if TellerId='0001' THEN --Admin he thong
        v_sql:='SELECT  TXNUM,TXDESC,CCYCD,AMOUNT,TLNAME,TXTIME,SHORTNAME,BRNAME,BRPHONE,NOTE
           FROM (
                 SELECT    l.txnum,x.EN_txdesc txdesc,f.bankacctno,f.ccycd,l.msgamt amount,p.tlname,l.txtime,m.shortname,mx1.extraval brname,
