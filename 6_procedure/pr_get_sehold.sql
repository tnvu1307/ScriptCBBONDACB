SET DEFINE OFF;
CREATE OR REPLACE PROCEDURE pr_get_sehold (PV_REFCURSOR IN OUT PKG_REPORT.REF_CURSOR,
...
begin
    ...
    if TellerId='0001' THEN --Admin he thong
        v_sql:='SELECT TXNUM,TXDESC,SYMBOL,QTTY,TLNAME,TXTIME,SHORTNAME,BRNAME,BRPHONE,NOTE
             FROM (
            SELECT   l.txnum,x.txdesc,l.cfcustodycd custodycd,f.symbol,l.msgamt qtty,p.tlname,l.txtime,m.shortname,mx1.extraval brname,
                     mx2.extraval brphone, note
              FROM   tllog l,
                     tltx x,
                     famembers m,
                     famembersextra mx1,
