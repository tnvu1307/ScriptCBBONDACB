SET DEFINE OFF;
CREATE OR REPLACE PACKAGE TXPKS_#1503EX
/**----------------------------------------------------------------------------------------------------
 ** Package: TXPKS_#1503EX
...
CREATE OR REPLACE PACKAGE BODY TXPKS_#1503EX
IS
   pkgctx   plog.log_ctx;
   logrow   tlogdebug%ROWTYPE;

   c_settlementdate   CONSTANT CHAR(2) := '09';
